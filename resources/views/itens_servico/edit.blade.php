...
<div class="page-wrapper">
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        <i class="fa-solid fa-pen icon me-2"></i>
                        Editar Item de Serviço
                    </h2>
                </div>
                <div class="col-auto ms-auto d-print-none">
                    <a href="{{ route('itens-servico.show', $item) }}" class="btn btn-outline-primary">
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <form method="POST" action="{{ route('itens-servico.update', $item) }}" class="card">
                @csrf
                @method('PUT')
                ...
                <div class="card-body row g-3">
                    <div class="col-lg-8">
                        ...
                        <textarea name="descricao_item" id="descricao_item" class="form-control @error('descricao_item') is-invalid @enderror" required rows="2">{{ old('descricao_item', $item->descricao_item) }}</textarea>
                    ...
                    <div class="col-lg-4">
                        ...
                        <select name="servico_id" id="servico_id" class="form-select @error('servico_id') is-invalid @enderror" required>
                            ...
                            @foreach($servicos as $servico)
                                <option value="{{ $servico->id }}" @if(old('servico_id', $item->servico_id) == $servico->id) selected @endif>{{ $servico->nome }}</option>
                            @endforeach
                        </select>
                        @error('servico_id')
                            <div class="invalid-feedback d-block">{{ $message }}</div>

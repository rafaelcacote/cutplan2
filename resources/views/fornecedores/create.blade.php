                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('endereco.endereco') is-invalid @enderror" name="endereco[endereco]" value="{{ old('endereco.endereco') }}" placeholder="Rua, Avenida..." maxlength="150" id="endereco">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('endereco.numero') is-invalid @enderror" name="endereco[numero]" value="{{ old('endereco.numero') }}" placeholder="123" maxlength="10" id="numero">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('endereco.bairro') is-invalid @enderror" name="endereco[bairro]" value="{{ old('endereco.bairro') }}" placeholder="Nome do bairro" maxlength="45" id="bairro">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('endereco.estado_id') is-invalid @enderror" name="endereco[estado_id]" id="estado_id">
                                                ...
                                                @foreach($estados as $estado)
                                                    <option value="{{ $estado->id }}" {{ old('endereco.estado_id') == $estado->id ? 'selected' : '' }}>{{ $estado->nome }} ({{ $estado->uf }})</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('endereco.complemento') is-invalid @enderror" name="endereco[complemento]" value="{{ old('endereco.complemento') }}" placeholder="Apto, Bloco..." maxlength="150" id="complemento">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('endereco.referencia') is-invalid @enderror" name="endereco[referencia]" value="{{ old('endereco.referencia') }}" placeholder="Próximo ao..." maxlength="255" id="referencia">

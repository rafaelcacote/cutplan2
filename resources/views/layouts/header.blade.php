...
<header class="navbar navbar-expand-md d-print-none w-100">
    <div class="container-fluid w-100">
        <!-- BEGIN NAVBAR TOGGLER (removido - conflito com sidebar) -->
        <!-- END NAVBAR TOGGLER -->
        <!-- BEGIN NAVBAR LOGO -->
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown"
                    ...
                    @if(isset($userTenant) && $userTenant && $userTenant->logo)
                        <div class="d-flex align-items-center">
                            <img src="{{ Storage::url($userTenant->logo) }}" 
                                 alt="{{ $userTenant->nome }}" 
                                 class="company-logo-header"
                                 style="height: 32px; width: auto; max-width: 120px; object-fit: contain; border-radius: 4px;">
                        </div>
                    @else
                    ...
                    <div class="d-none d-xl-block ps-2">
                        ...
                        @if(isset($userTenant) && $userTenant)
                            <div class="text-secondary" style="font-size: 0.75rem; line-height: 1.2;">{{ Str::limit($userTenant->nome, 25) }}</div>
                        @endif
                    </div>
                </a>
